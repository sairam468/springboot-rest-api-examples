...
public class Runner1 implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		//Define Service Url
		String serviceUrl="http://localhost:4040/Provider/actor/find";
	    ...
	    Actor a=mapper.readValue(jsonBody,//body
	    		Actor.class);             //required object type
	    
	    System.out.println("response body as actor object data :"+a);
	}
