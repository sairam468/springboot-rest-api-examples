...
public class Runner4 implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		String Url="http://localhost:4040/RestMiniProject/tourist/modify";
		String json_body = "{"
				+ "\"tid\": 959,"  // Include the ID for update
				+ "\"name\": \"Rohit Sharma\","
				+ "\"city\": \"Mumbai\","
				+ "\"packageType\": \"Premium\","
				+ "\"budget\": 1500.50"
		...
		ResponseEntity<String> result = template.exchange(Url,HttpMethod.PATCH, entity,String.class);
